...
main_domain="api.proposta.liga.viniciusl.com.br"
domains=(api.proposta.liga.viniciusl.com.br proposta.liga.viniciusl.com.br storage.proposta.liga.viniciusl.com.br)
rsa_key_size=4096
data_path="./certbot"
email="vinicius.cardoso23@etec.sp.gov.br" # Adding a valid address is strongly recommended
